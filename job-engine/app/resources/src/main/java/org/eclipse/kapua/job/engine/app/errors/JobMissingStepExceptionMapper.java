...
public class JobMissingStepExceptionMapper implements ExceptionMapper<JobMissingStepException> {
    ...
    @Inject
    public JobMissingStepExceptionMapper(ExceptionConfigurationProvider exceptionConfigurationProvider) {
    ...
    public Response toResponse(JobMissingStepException jobMissingStepException) {
        ...
        return Response
                ...
                .entity(new JobMissingStepExceptionInfo(jobMissingStepException, showStackTrace))
                .build();
    }
