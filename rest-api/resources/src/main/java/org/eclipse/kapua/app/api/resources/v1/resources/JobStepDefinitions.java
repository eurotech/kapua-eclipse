...
public class JobStepDefinitions extends AbstractKapuaResource {
    ...
    public JobStepDefinitionListResult simpleQuery(
        ...
        JobStepDefinitionQuery query = new JobStepDefinitionQuery(scopeId);
    ...
    /**
     * Queries the results with the given {@link JobStepDefinitionQuery} parameter.
     *
     * @param scopeId
     *         The {@link ScopeId} in which to search results.
     * @param query
     *         The {@link JobStepDefinitionQuery} to use to filter results.
     * @return The {@link JobStepListResult} of all the result matching the given {@link JobStepDefinitionQuery} parameter.
     * @throws KapuaException
     *         Whenever something bad happens. See specific {@link KapuaService} exceptions.
     * @since 1.5.0
     */
